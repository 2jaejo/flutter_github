...
class PageForeground extends StatefulWidget {
  final String title;
  final String message;

  PageForeground({Key? key, this.title = "", this.message = ''})
      : super(key: key);

  @override
  State<PageForeground> createState() => _PageForegroundState();
}

class _PageForegroundState extends State<PageForeground> {
  String title = '';
